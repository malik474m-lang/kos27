...
if ($method === 'GET') {
    ...
    echo json_encode([
        ...
        'availableTextModels' => [
            'odirouter' => [
                'free-gpt-5.6-luna' => 'GPT-5.6 Luna (free)',
                'free-gpt-5.6-terra' => 'GPT-5.6 Terra (free)',
                'free-gpt-5.4-mini' => 'GPT-5.4 Mini (free)',
                'free-grok-4.5' => 'Grok 4.5 (free)',
                'free-gemini-3.5-flash' => 'Gemini 3.5 Flash (free)',
                'free-gemini-2.5-flash' => 'Gemini 2.5 Flash (free)',
                'free-qwen3.7-plus' => 'Qwen 3.7 Plus (free)',
                'free-claude-haiku-4.5' => 'Claude Haiku 4.5 (free)',
                'free-minimax-m2.7' => 'MiniMax M2.7 (free)',
            ],
        ...
        'availableImageModels' => [
            'odirouter' => [
                'free-nano-banana-2' => 'Nano Banana 2 (free)',
            ],
