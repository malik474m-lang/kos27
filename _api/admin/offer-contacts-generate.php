...
$prompt = <<<PROMPT
Дай справочную информацию о {$offerTitle}.
...
3. Не придумывай номер лицензии, телефон или адрес.
4. trademark — это юридическое название компании, если оно известно точно.
5. license — только номер лицензии ЦБ РФ без дополнительных пояснений.
6. phone — только телефон поддержки или горячей линии.
