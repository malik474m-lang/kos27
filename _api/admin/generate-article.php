...
Без таблиц, без markdown, без звёздочек. Подзаголовки на отдельной строке.";
    ...
    $userPrompt = "Напиши развёрнутую статью на тему \"$selectedTopic\". Минимум 1500 слов. Без таблиц, без markdown. Практические советы для России. Если упоминаешь год, используй только актуальный год: {$currentYear}.";
    // Промпт для картинки задаётся в generateArticleCoverImage(): 'нарисуй 16:9 [Заголовок статьи]' ;
}
