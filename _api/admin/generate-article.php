...
function buildArticleOutlineTemplate(string $topic, string $category, bool $isBank = false, bool $isMFO = false): array {
    if ($isBank) {
        return [
            'Краткое введение и позиционирование банка на рынке',
            'Юридическая информация, лицензия ЦБ и контакты',
            'Основные продукты банка для физических лиц',
            'Условия по кредитам, картам и другим услугам',
            'Онлайн-сервисы, мобильное приложение и удобство использования',
            'Преимущества, недостатки и кому подойдёт банк',
        ];
    }
    if ($isMFO) {
        return [
            'Что это за МФО и как она работает',
            'Лицензия, юридические данные и контакты',
            'Условия займов: суммы, сроки, ставки и ПСК',
            'Как оформить займ и какие требования к заёмщику',
            'Способы получения и погашения займа',
            'Преимущества, недостатки и кому подойдёт сервис',
        ];
    }

    $map = [
        'займы' => [
            'Что нужно знать по теме и кому это подходит',
            'На какие условия смотреть при выборе предложения',
            'Пошаговая инструкция оформления',
            'Типичные ошибки и как их избежать',
            'Практические советы перед подачей заявки',
            'Выводы и кому подойдёт такой вариант',
        ],
        'кредиты' => [
            'Что означает этот продукт и когда он нужен',
            'Как сравнивать ставки, ПСК и дополнительные условия',
            'Какие требования банки предъявляют заёмщикам',
            'Как подать заявку и повысить шансы на одобрение',
            'Риски, переплата и важные пункты договора',
            'Итоги и рекомендации по выбору',
        ],
        'карты' => [
            'Для каких задач подходит такой тип карты',
            'На какие условия смотреть: обслуживание, кэшбэк, льготный период',
            'Как сравнить предложения разных банков',
            'Как оформить карту и что проверить до подачи заявки',
            'Подводные камни и частые ошибки',
            'Кому подойдёт такая карта и какие есть альтернативы',
        ],
    ];

    return $map[$category] ?? [
        'Что это такое и в каких случаях подходит',
        'Ключевые критерии выбора',
        'Как оформить и что проверить заранее',
