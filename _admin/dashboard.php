...
function cqSetInlineScore(prefix, score){
  ...
  if(badge){
    badge.className='inline-flex items-center rounded-full px-2.5 py-1 text-xs font-semibold '+cqBadgeClass(score);
