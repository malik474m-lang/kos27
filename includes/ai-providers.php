    ...
    foreach ($keys as $activeKey) {
        ...
        for ($i = 0; $i < 24; $i++) {
            ...
            if (in_array($statusCode, [401,402,403,408,429,500,502,503,504], true)) {
                ...
                if ($statusCode === 429 && $keyAccount) { $blockedAccounts[$keyAccount] = true; odiHandle429($activeKey['id']); }
            ...
            if ($status === 'COMPLETED') {
                ...
                if (in_array($resultCode, [401,402,403,408,429,500,502,503,504], true)) {
                    ...
                    if ($resultCode === 429 && $keyAccount) { $blockedAccounts[$keyAccount] = true; odiHandle429($activeKey['id']); }
